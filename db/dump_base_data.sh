...
TABLES='carreteras curvas_nivel_10m rios equipamientos caserios_comunidades areas_protegidas_2011 usos_suelo_2003 oceano paises_limitrofes departamentos municipios cantones'
# honduras
